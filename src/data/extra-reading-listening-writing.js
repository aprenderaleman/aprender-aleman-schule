...
export const A1_EXTRA_EXERCISES = [
  ...
  { id:'r-a1-007', type:'reading', subtype:'comprehension', level:'A1', unit:1, title:'Mein Morgen',
    ...
    vocabulary:[{word:'aufstehen',translation:'levantarse',defDe:'aus dem Bett steigen'},{word:'frühstücken',translation:'desayunar',defDe:'das Frühstück zu sich nehmen'},{word:'das Brot',translation:'el pan',defDe:'Backware aus Mehl'},{word:'die Marmelade',translation:'la mermelada',defDe:'süßer Aufstrich aus Früchten'}],
    questions:[
  ...
  { id:'r-a1-008', type:'reading', subtype:'comprehension', level:'A1', unit:1, title:'Meine Familie',
    ...
    vocabulary:[{word:'die Familie',translation:'la familia',defDe:'Eltern und Kinder'},{word:'der Vater',translation:'el padre',defDe:'männlicher Elternteil'},{word:'die Mutter',translation:'la madre',defDe:'weiblicher Elternteil'},{word:'der Bruder',translation:'el hermano',defDe:'männliches Geschwisterkind'}],
    questions:[
  ...
  { id:'r-a1-009', type:'reading', subtype:'comprehension', level:'A1', unit:1, title:'Im Supermarkt',
    ...
    vocabulary:[{word:'der Supermarkt',translation:'el supermercado',defDe:'großes Geschäft für Lebensmittel'},{word:'kaufen',translation:'comprar',defDe:'etwas gegen Geld erwerben'},{word:'die Milch',translation:'la leche',defDe:'weißes Getränk von Kühen'},{word:'kosten',translation:'costar',defDe:'einen bestimmten Preis haben'}],
    questions:[
  ...
  { id:'r-a1-010', type:'reading', subtype:'comprehension', level:'A1', unit:2, title:'Das Wetter heute',
    ...
    vocabulary:[{word:'das Wetter',translation:'el tiempo (meteorológico)',defDe:'Klima und Temperatur draußen'},{word:'die Sonne',translation:'el sol',defDe:'Stern am Tag, gibt Licht und Wärme'},{word:'scheinen',translation:'brillar',defDe:'Licht geben, leuchten'},{word:'warm',translation:'cálido',defDe:'nicht kalt, angenehme Temperatur'}],
    questions:[
  ...
  { id:'r-a1-011', type:'reading', subtype:'comprehension', level:'A1', unit:2, title:'Mein Zimmer',
    ...
    vocabulary:[{word:'das Zimmer',translation:'la habitación',defDe:'Raum in einer Wohnung'},{word:'gemütlich',translation:'acogedor',defDe:'angenehm und behaglich'},{word:'der Schreibtisch',translation:'el escritorio',defDe:'Tisch zum Arbeiten oder Lernen'},{word:'der Schrank',translation:'el armario',defDe:'Möbel zum Aufbewahren von Kleidung'}],
    questions:[
  ...
  { id:'r-a1-012', type:'reading', subtype:'comprehension', level:'A1', unit:2, title:'Meine Hobbys',
    ...
    vocabulary:[{word:'das Hobby',translation:'la afición',defDe:'Beschäftigung in der Freizeit'},{word:'spielen',translation:'jugar',defDe:'sich mit einem Spiel beschäftigen'},{word:'lesen',translation:'leer',defDe:'Texte mit den Augen aufnehmen'},{word:'kochen',translation:'cocinar',defDe:'Essen zubereiten'}],
    questions:[
  ...
  { id:'r-a1-013', type:'reading', subtype:'comprehension', level:'A1', unit:2, title:'Der Hund',
    ...
    vocabulary:[{word:'der Hund',translation:'el perro',defDe:'Haustier, das bellt'},{word:'der Garten',translation:'el jardín',defDe:'Grünfläche am Haus mit Pflanzen'},{word:'fressen',translation:'comer (animales)',defDe:'essen (bei Tieren)'},{word:'das Fleisch',translation:'la carne',defDe:'Nahrungsmittel von Tieren'}],
    questions:[
  ...
  { id:'r-a1-014', type:'reading', subtype:'comprehension', level:'A1', unit:3, title:'Im Restaurant',
    ...
    vocabulary:[{word:'das Restaurant',translation:'el restaurante',defDe:'Ort, wo man Essen kaufen und essen kann'},{word:'bestellen',translation:'pedir (en un restaurante)',defDe:'etwas beim Kellner anfordern'},{word:'die Suppe',translation:'la sopa',defDe:'flüssiges warmes Gericht'},{word:'schmecken',translation:'saber, tener un sabor',defDe:'einen bestimmten Geschmack haben'}],
    questions:[
  ...
  { id:'r-a1-015', type:'reading', subtype:'comprehension', level:'A1', unit:3, title:'Die Schule',
    ...
    vocabulary:[{word:'die Schule',translation:'la escuela',defDe:'Ort, wo Kinder lernen'},{word:'der Unterricht',translation:'la clase, la enseñanza',defDe:'Zeit, in der der Lehrer etwas erklärt'},{word:'das Lieblingsfach',translation:'la asignatura favorita',defDe:'das Schulfach, das man am meisten mag'},{word:'die Pause',translation:'el recreo, la pausa',defDe:'kurze Unterbrechung zum Ausruhen'}],
    questions:[
  ...
  { id:'r-a1-016', type:'reading', subtype:'comprehension', level:'A1', unit:3, title:'Eine Postkarte',
    ...
    vocabulary:[{word:'die Postkarte',translation:'la postal',defDe:'Karte mit Bild, die man per Post schickt'},{word:'besuchen',translation:'visitar',defDe:'zu jemandem oder an einen Ort gehen'},{word:'das Schloss',translation:'el palacio, el castillo',defDe:'großes historisches Gebäude für Könige'},{word:'lecker',translation:'rico, sabroso',defDe:'sehr gut im Geschmack'}],
    questions:[
...
export const A2_EXTRA_EXERCISES = [
  ...
  { id:'r-a2-007', type:'reading', subtype:'comprehension', level:'A2', unit:1, title:'Ein neuer Job',
    ...
    vocabulary:[{word:'die Firma',translation:'la empresa',defDe:'Unternehmen, wo man arbeitet'},{word:'der Kollege',translation:'el compañero de trabajo',defDe:'Person, mit der man zusammenarbeitet'},{word:'die Mittagspause',translation:'la pausa del mediodía',defDe:'Pause am Mittag zum Essen'},{word:'die Kantine',translation:'el comedor de empresa',defDe:'Essensraum in einer Firma oder Schule'}],
    questions:[
  ...
  { id:'r-a2-008', type:'reading', subtype:'comprehension', level:'A2', unit:1, title:'Der Umzug',
    ...
    vocabulary:[{word:'umziehen',translation:'mudarse',defDe:'in eine neue Wohnung ziehen'},{word:'die Miete',translation:'el alquiler',defDe:'Geld, das man monatlich für die Wohnung zahlt'},{word:'die Lage',translation:'la ubicación',defDe:'der Ort, wo etwas liegt'},{word:'der Umzug',translation:'la mudanza',defDe:'der Wechsel in eine andere Wohnung'}],
    questions:[
  ...
  { id:'r-a2-009', type:'reading', subtype:'comprehension', level:'A2', unit:1, title:'Deutschkurs',
    ...
    vocabulary:[{word:'die Volkshochschule',translation:'el centro de formación para adultos',defDe:'Bildungseinrichtung für Erwachsene'},{word:'stattfinden',translation:'tener lugar',defDe:'passieren, geschehen (an einem Ort/Zeit)'},{word:'geduldig',translation:'paciente',defDe:'ruhig warten können, nicht schnell ärgerlich'},{word:'die Hausaufgaben',translation:'los deberes',defDe:'Aufgaben, die man zu Hause macht'}],
    questions:[
  ...
  { id:'r-a2-010', type:'reading', subtype:'comprehension', level:'A2', unit:2, title:'Ein Ausflug ins Museum',
    ...
    vocabulary:[{word:'das Naturkundemuseum',translation:'el museo de ciencias naturales',defDe:'Museum über Tiere, Pflanzen und Natur'},{word:'die Ausstellung',translation:'la exposición',defDe:'Präsentation von Objekten zum Ansehen'},{word:'das Skelett',translation:'el esqueleto',defDe:'die Knochen eines Körpers'},{word:'der Eintritt',translation:'la entrada (precio)',defDe:'Preis, den man zum Hineingehen zahlt'}],
    questions:[
  ...
  { id:'r-a2-011', type:'reading', subtype:'comprehension', level:'A2', unit:2, title:'Gesund leben',
    ...
    vocabulary:[{word:'gesund',translation:'sano, saludable',defDe:'gut für den Körper, nicht krank'},{word:'die Süßigkeiten',translation:'los dulces',defDe:'Schokolade, Bonbons und andere süße Sachen'},{word:'joggen',translation:'correr, hacer footing',defDe:'langsam laufen als Sport'},{word:'die Energie',translation:'la energía',defDe:'Kraft, um etwas zu tun'}],
    questions:[
  ...
  { id:'r-a2-012', type:'reading', subtype:'comprehension', level:'A2', unit:2, title:'Reise nach Wien',
    ...
    vocabulary:[{word:'reisen',translation:'viajar',defDe:'an einen anderen Ort fahren'},{word:'der Zug',translation:'el tren',defDe:'Verkehrsmittel auf Schienen'},{word:'die Sachertorte',translation:'la tarta Sacher (tarta vienesa de chocolate)',defDe:'berühmte Schokoladentorte aus Wien'},{word:'der Blick',translation:'la vista',defDe:'das, was man sieht'}],
    questions:[
  ...
  { id:'r-a2-013', type:'reading', subtype:'comprehension', level:'A2', unit:2, title:'Der Flohmarkt',
    ...
    vocabulary:[{word:'der Flohmarkt',translation:'el mercadillo, el rastro',defDe:'Markt mit gebrauchten Sachen'},{word:'das Fahrrad',translation:'la bicicleta',defDe:'Verkehrsmittel mit zwei Rädern und Pedalen'},{word:'die Ohrringe',translation:'los pendientes',defDe:'Schmuck für die Ohren'},{word:'der Ausflug',translation:'la excursión',defDe:'kurze Reise für den Tag'}],
    questions:[
  ...
  { id:'r-a2-014', type:'reading', subtype:'comprehension', level:'A2', unit:3, title:'Weihnachten in Deutschland',
    ...
    vocabulary:[{word:'Weihnachten',translation:'la Navidad',defDe:'christliches Fest im Dezember'},{word:'Heiligabend',translation:'la Nochebuena',defDe:'der Abend des 24. Dezember'},{word:'schmücken',translation:'decorar, adornar',defDe:'etwas schön dekorieren'},{word:'die Geschenke',translation:'los regalos',defDe:'Dinge, die man anderen gibt'}],
    questions:[
  ...
  { id:'r-a2-015', type:'reading', subtype:'comprehension', level:'A2', unit:3, title:'Sport im Verein',
    ...
    vocabulary:[{word:'der Sportverein',translation:'el club deportivo',defDe:'Gruppe von Menschen, die zusammen Sport machen'},{word:'das Training',translation:'el entrenamiento',defDe:'das Üben einer Sportart'},{word:'die Mannschaft',translation:'el equipo',defDe:'Gruppe von Spielern im Teamsport'},{word:'die Meisterschaft',translation:'el campeonato',defDe:'großes Turnier um den besten Platz'}],
    questions:[
  ...
  { id:'r-a2-016', type:'reading', subtype:'comprehension', level:'A2', unit:3, title:'Ein Brief von der Vermieterin',
    ...
    vocabulary:[{word:'die Vermieterin',translation:'la casera, la arrendadora',defDe:'Frau, der die Wohnung gehört'},{word:'der Müll',translation:'la basura',defDe:'Dinge, die man wegwirft'},{word:'die Tonne',translation:'el contenedor',defDe:'großer Behälter für Müll'},{word:'die Ruhezeit',translation:'el horario de silencio',defDe:'Zeit, in der man leise sein muss'}],
    questions:[
