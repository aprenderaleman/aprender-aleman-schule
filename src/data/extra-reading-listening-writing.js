...
export const A1_EXTRA_EXERCISES = [
  ...
  { id:'r-a1-007', type:'reading', subtype:'comprehension', level:'A1', unit:1, title:'Mein Morgen',
    ...
    vocabulary:[{word:'aufstehen',translation:'levantarse'},{word:'frühstücken',translation:'desayunar'},{word:'das Brot',translation:'el pan'},{word:'die Marmelade',translation:'la mermelada'}],
    questions:[
  ...
  { id:'r-a1-008', type:'reading', subtype:'comprehension', level:'A1', unit:1, title:'Meine Familie',
    ...
    vocabulary:[{word:'die Familie',translation:'la familia'},{word:'der Vater',translation:'el padre'},{word:'die Mutter',translation:'la madre'},{word:'der Bruder',translation:'el hermano'}],
    questions:[
  ...
  { id:'r-a1-009', type:'reading', subtype:'comprehension', level:'A1', unit:1, title:'Im Supermarkt',
    ...
    vocabulary:[{word:'der Supermarkt',translation:'el supermercado'},{word:'kaufen',translation:'comprar'},{word:'die Milch',translation:'la leche'},{word:'kosten',translation:'costar'}],
    questions:[
  ...
  { id:'r-a1-010', type:'reading', subtype:'comprehension', level:'A1', unit:2, title:'Das Wetter heute',
    ...
    vocabulary:[{word:'das Wetter',translation:'el tiempo (clima)'},{word:'die Sonne',translation:'el sol'},{word:'scheinen',translation:'brillar'},{word:'warm',translation:'cálido'}],
    questions:[
  ...
  { id:'r-a1-011', type:'reading', subtype:'comprehension', level:'A1', unit:2, title:'Mein Zimmer',
    ...
    vocabulary:[{word:'das Zimmer',translation:'la habitación'},{word:'gemütlich',translation:'acogedor'},{word:'der Schreibtisch',translation:'el escritorio'},{word:'der Schrank',translation:'el armario'}],
    questions:[
  ...
  { id:'r-a1-012', type:'reading', subtype:'comprehension', level:'A1', unit:2, title:'Meine Hobbys',
    ...
    vocabulary:[{word:'das Hobby',translation:'el hobby'},{word:'spielen',translation:'jugar'},{word:'lesen',translation:'leer'},{word:'kochen',translation:'cocinar'}],
    questions:[
  ...
  { id:'r-a1-013', type:'reading', subtype:'comprehension', level:'A1', unit:2, title:'Der Hund',
    ...
    vocabulary:[{word:'der Hund',translation:'el perro'},{word:'der Garten',translation:'el jardín'},{word:'fressen',translation:'comer (animales)'},{word:'das Fleisch',translation:'la carne'}],
    questions:[
  ...
  { id:'r-a1-014', type:'reading', subtype:'comprehension', level:'A1', unit:3, title:'Im Restaurant',
    ...
    vocabulary:[{word:'das Restaurant',translation:'el restaurante'},{word:'bestellen',translation:'pedir'},{word:'die Suppe',translation:'la sopa'},{word:'schmecken',translation:'saber (sabor)'}],
    questions:[
  ...
  { id:'r-a1-015', type:'reading', subtype:'comprehension', level:'A1', unit:3, title:'Die Schule',
    ...
    vocabulary:[{word:'die Schule',translation:'la escuela'},{word:'der Unterricht',translation:'la clase'},{word:'das Lieblingsfach',translation:'la asignatura favorita'},{word:'die Pause',translation:'el recreo'}],
    questions:[
  ...
  { id:'r-a1-016', type:'reading', subtype:'comprehension', level:'A1', unit:3, title:'Eine Postkarte',
    ...
    vocabulary:[{word:'die Postkarte',translation:'la postal'},{word:'besuchen',translation:'visitar'},{word:'das Schloss',translation:'el castillo'},{word:'lecker',translation:'delicioso'}],
    questions:[
...
export const A2_EXTRA_EXERCISES = [
  ...
  { id:'r-a2-007', type:'reading', subtype:'comprehension', level:'A2', unit:1, title:'Ein neuer Job',
    ...
    vocabulary:[{word:'die Firma',translation:'la empresa'},{word:'der Kollege',translation:'el compañero de trabajo'},{word:'die Mittagspause',translation:'la pausa del almuerzo'},{word:'die Kantine',translation:'la cantina/comedor'}],
    questions:[
  ...
  { id:'r-a2-008', type:'reading', subtype:'comprehension', level:'A2', unit:1, title:'Der Umzug',
    ...
    vocabulary:[{word:'umziehen',translation:'mudarse'},{word:'die Miete',translation:'el alquiler'},{word:'die Lage',translation:'la ubicación'},{word:'der Umzug',translation:'la mudanza'}],
    questions:[
  ...
  { id:'r-a2-009', type:'reading', subtype:'comprehension', level:'A2', unit:1, title:'Deutschkurs',
    ...
    vocabulary:[{word:'die Volkshochschule',translation:'la escuela popular (de adultos)'},{word:'stattfinden',translation:'tener lugar'},{word:'geduldig',translation:'paciente'},{word:'die Hausaufgaben',translation:'los deberes'}],
    questions:[
  ...
  { id:'r-a2-010', type:'reading', subtype:'comprehension', level:'A2', unit:2, title:'Ein Ausflug ins Museum',
    ...
    vocabulary:[{word:'das Naturkundemuseum',translation:'el museo de ciencias naturales'},{word:'die Ausstellung',translation:'la exposición'},{word:'das Skelett',translation:'el esqueleto'},{word:'der Eintritt',translation:'la entrada (precio)'}],
    questions:[
  ...
  { id:'r-a2-011', type:'reading', subtype:'comprehension', level:'A2', unit:2, title:'Gesund leben',
    ...
    vocabulary:[{word:'gesund',translation:'sano/saludable'},{word:'die Süßigkeiten',translation:'los dulces'},{word:'joggen',translation:'hacer jogging'},{word:'die Energie',translation:'la energía'}],
    questions:[
  ...
  { id:'r-a2-012', type:'reading', subtype:'comprehension', level:'A2', unit:2, title:'Reise nach Wien',
    ...
    vocabulary:[{word:'reisen',translation:'viajar'},{word:'der Zug',translation:'el tren'},{word:'die Sachertorte',translation:'la tarta Sacher'},{word:'der Blick',translation:'la vista'}],
    questions:[
  ...
  { id:'r-a2-013', type:'reading', subtype:'comprehension', level:'A2', unit:2, title:'Der Flohmarkt',
    ...
    vocabulary:[{word:'der Flohmarkt',translation:'el mercadillo'},{word:'das Fahrrad',translation:'la bicicleta'},{word:'die Ohrringe',translation:'los pendientes'},{word:'der Ausflug',translation:'la excursión'}],
    questions:[
  ...
  { id:'r-a2-014', type:'reading', subtype:'comprehension', level:'A2', unit:3, title:'Weihnachten in Deutschland',
    ...
    vocabulary:[{word:'Weihnachten',translation:'Navidad'},{word:'Heiligabend',translation:'Nochebuena'},{word:'schmücken',translation:'decorar'},{word:'die Geschenke',translation:'los regalos'}],
    questions:[
  ...
  { id:'r-a2-015', type:'reading', subtype:'comprehension', level:'A2', unit:3, title:'Sport im Verein',
    ...
    vocabulary:[{word:'der Sportverein',translation:'el club deportivo'},{word:'das Training',translation:'el entrenamiento'},{word:'die Mannschaft',translation:'el equipo'},{word:'die Meisterschaft',translation:'el campeonato'}],
    questions:[
  ...
  { id:'r-a2-016', type:'reading', subtype:'comprehension', level:'A2', unit:3, title:'Ein Brief von der Vermieterin',
    ...
    vocabulary:[{word:'die Vermieterin',translation:'la arrendadora'},{word:'der Müll',translation:'la basura'},{word:'die Tonne',translation:'el contenedor'},{word:'die Ruhezeit',translation:'el horario de silencio'}],
    questions:[
