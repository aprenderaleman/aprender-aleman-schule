...
const SKILL_PITCH = {
  grammar: {
    emoji: '📚',
    title: 'Probiere eine Grammatikübung aus',
  ...
  reading: {
    emoji: '📖',
    title: 'Probiere eine Leseübung aus',
  ...
  listening: {
    emoji: '🎧',
    title: 'Probiere eine Höraufgabe aus',
  ...
  writing: {
    emoji: '✍️',
    title: 'Probiere eine Schreibübung aus',
  ...
  speaking: {
    emoji: '🎙️',
    title: 'Probiere eine Sprechübung aus',
