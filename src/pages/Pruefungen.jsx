...
function PruefungsWizard({ onComplete, initialError }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      <Navbar />
      <main id="main" className="flex-1 max-w-5xl md:pl-60 w-full mx-auto px-4 sm:px-6 py-8 md:py-12">
...
function PruefungsDashboard({ plan, onReset, onRefresh }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      <Navbar />
      <main id="main" className="flex-1 max-w-7xl md:pl-60 w-full mx-auto px-4 sm:px-6 py-8">
        <div className="mb-8">
