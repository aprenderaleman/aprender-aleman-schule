// Registro de los Übungshefte del A1 — un cuaderno por lección.
// Formato: docs/deutscha1/HEFT-FORMAT.md. GENERADO: para editar un cuaderno,
...
export function getHeft(id) {
  return HEFTE[id] || null
}

export function hasHeft(id) {
  return Boolean(HEFTE[id])
}
