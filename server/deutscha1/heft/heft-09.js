  ...
  teile: [
    {
      ...
      items: [
        ...
        { typ: 'satzbau', woerter: ['hier', 'einen', 'gibt', 'Es', 'Park'], loesung: 'Es gibt hier einen Park.' },
        {
          typ: 'zuordnen',
        ...
        },
        {
          ...
          loesung: 0,
          warum: 'Nach *haben* wird ein → **einen** beim Maskulinum: *einen Hund*. ~~(Solo el masculino cambia.)~~',
        },
        {
          typ: 'korrektur',
          optionen: ['Das ist der Lehrer.', 'Das ist den Lehrer.'],
          loesung: 0,
          warum: 'Mit **sein** gibt es keinen Wechsel: *Das ist der Lehrer*. ~~(El cambio der → den solo va con haben, kaufen, trinken…)~~',
        },
      ],
    },
    {
      ...
      items: [
        ...
        { typ: 'rf', aussage: 'Leo kauft einen Salat, ein Brot und einen Käse.', loesung: true },
      ],
    },
    {
      typ: 'schreiben',
