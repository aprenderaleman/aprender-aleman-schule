...
export const B1_GESCHICHTEN = [
  { id: 91, titel: 'Geschichte 1 — Die Bewerbung' },
  { id: 92, titel: 'Geschichte 2 — Das Vorstellungsgespräch' },
  { id: 93, titel: 'Geschichte 3 — Ärger in der WG' },
  { id: 94, titel: 'Geschichte 4 — Die Reise nach Hamburg' },
  { id: 95, titel: 'Geschichte 5 — Eine wichtige Entscheidung' },
]
